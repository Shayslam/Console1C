...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ДобавитьКоманду(Команды, "Консоль 1С", "Консоль1С", "ОткрытиеФормы");
	
	РегистрационныеДанные.Вставить("Вид"             , "ДополнительнаяОбработка");
	РегистрационныеДанные.Вставить("Назначение"      , Неопределено);
	РегистрационныеДанные.Вставить("Наименование"    , "Консоль 1С");
	РегистрационныеДанные.Вставить("Версия"          , "2024.09.24");
	РегистрационныеДанные.Вставить("БезопасныйРежим" , Ложь);
	РегистрационныеДанные.Вставить("Информация"      , "Консоль 1С для управляемых форм");
...
ИмяОбработки = "Консоль1С";
ПолноеИмяОбработки = ИспользуемоеИмяФайла;
